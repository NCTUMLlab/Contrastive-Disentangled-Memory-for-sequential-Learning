...
resume= #"/home/container_user/hang/espnet/egs/aishell/com_asr/exp/train_sp_pytorch_transformer256GLU1280FF/results/snapshot.ep.22"        # Resume the training from snapshot

# feature configuration
do_delta=false

train_config=conf/train_transformer.yaml   #conf/train.yaml
...
# exp tag
tag="transformer256GLU1280FF" # tag for managing experiments.
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
	...
	# export LRU_CACHE_CAPACITY=16
    for rtask in ${recog_set}; do #${recog_set}
    (
